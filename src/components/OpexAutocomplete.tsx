...
interface OpexAutocompleteProps {
  value: string;
...
export function OpexAutocomplete({ value, onChange, placeholder, onKeyPress }: OpexAutocompleteProps) {
  ...
  const filteredResults = OPEX_FIELDS.map(category => ({
